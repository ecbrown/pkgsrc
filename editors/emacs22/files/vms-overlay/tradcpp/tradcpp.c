...
Copyright (C) 1986, 1987, 1989, 2000, 2001, 2003 Free Software Foundation, Inc.
		    ...
		    Extracted from gcc-3.2.2 for embedding in Emacs dist (for
		    building under VMS only), Thien-Thi Nguyen, April 2003
...
#include "localshared.h"
/* #include "config.h" */		/* ttn */
/* #include "system.h" */		/* ttn */
/* #include "version.h" */		/* ttn */
     ...
     char **argv;
{
...
#if 0 /* can we make do w/o this?  --ttn  */
  gcc_init_libintl ();
#endif
  ...
  if (print_deps)
    {
      /* [VMS] Don't support this.  */
      fatal ("printing dependencies not supported");
#if 0 /* ttn */
 ...
 sys_error:
  ...
  exit (FATAL_EXIT_CODE);               /* appease compiler (not reached) */
}
...
Please submit a full bug report.\n\
 (Sorry, no instructions available.)", func, line);
}
