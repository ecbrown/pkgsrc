...
#endif
  /* The load-average driver interface is unavailable on current OpenVMS
     x86-64.  Release the probe channel and report no load average.  */
  sys$dassgn (channel);
  getloadavg_initialized = 0;
